...
struct BlocketTokenProvider: TokenProvider {
    ...
    public var borderInverted: Color { Color.dynamicColor(defaultColor: BlocketColors.white, darkModeColor: BlocketColors.gray900) }
...
struct BlocketUITokenProvider: UITokenProvider {
    ...
    public var borderInverted: UIColor { UIColor.dynamicColor(defaultColor: BlocketUIColors.white, darkModeColor: BlocketUIColors.gray900) }
